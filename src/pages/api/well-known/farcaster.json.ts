...
export default function handler(
  ...
  const manifest: {
    ...
    miniapp: {
      version: '1',
      name: 'D New Tech',
      description: 'D New Tech - Detroit New Technology Community',
      iconUrl: `${APP_URL}/images/d-new-tech-logo.png`,
      homeUrl: APP_URL,
      canonicalDomain: domain,
      // Recommended fields for better discovery and presentation
      imageUrl: `${APP_URL}/images/d-new-tech-logo.png`,
      buttonTitle: 'Open D New Tech',
      splashImageUrl: `${APP_URL}/images/d-new-tech-logo.png`,
      splashBackgroundColor: '#000000',
      subtitle: 'Detroit New Tech', // Max 30 chars
      tagline: 'Tech Community', // Max 30 chars
      ogTitle: 'D New Tech', // Max 30 chars
      ogDescription: 'D New Tech - Detroit New Technology Community', // Max 100 chars
      ogImageUrl: `${APP_URL}/images/d-new-tech-logo.png`,
      // Optional categorization
      primaryCategory: 'social',
      tags: ['tech', 'detroit', 'community', 'farcaster', 'miniapp'],
    },
  };
